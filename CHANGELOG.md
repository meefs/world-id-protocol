...
## [0.4.5](https://github.com/meefs/world-id-protocol/compare/world-id-primitives-v0.4.4...world-id-primitives-v0.4.5) - 2026-03-02

### Added

- Rust Proof Input verification with nicer errors ([#338](https://github.com/meefs/world-id-protocol/pull/338))
- *(gateway)* add a batch submit policy ([#505](https://github.com/meefs/world-id-protocol/pull/505))
- println -> tracing:: ([#474](https://github.com/meefs/world-id-protocol/pull/474))
- gateway orphan sweeper ([#494](https://github.com/meefs/world-id-protocol/pull/494))

### Other

- gateway config ([#506](https://github.com/meefs/world-id-protocol/pull/506))
