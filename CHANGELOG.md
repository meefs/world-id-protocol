...
## [0.5.3](https://github.com/meefs/world-id-protocol/compare/world-id-primitives-v0.5.2...world-id-primitives-v0.5.3) - 2026-03-14

### Fixed

- signer doesn't need to be mutable ([#556](https://github.com/meefs/world-id-protocol/pull/556))
