...
## [0.6.1](https://github.com/meefs/world-id-protocol/compare/world-id-primitives-v0.6.0...world-id-primitives-v0.6.1) - 2026-03-23

### Added

- rename to associated data commitment ([#586](https://github.com/meefs/world-id-protocol/pull/586))
- *(indexer)* expose offchain_signer_commitment ([#593](https://github.com/meefs/world-id-protocol/pull/593))
- recovery agent management gateway endpoints ([#589](https://github.com/meefs/world-id-protocol/pull/589))
- separate action prefix ([#581](https://github.com/meefs/world-id-protocol/pull/581))

### Other

- increase zstd compression level to 9 for circuit files ([#591](https://github.com/meefs/world-id-protocol/pull/591))
